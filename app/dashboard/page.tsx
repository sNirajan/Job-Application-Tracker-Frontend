...
function StatCard({
  ...
  return (
    <div
      ...
      style={{
        backgroundColor:
          tone === "accent" ? "var(--bg-green)" : "var(--bg-card)",
        borderColor:
          tone === "accent" ? "var(--accent-quiet)" : "var(--border-light)",
      }}
    >
...
export default function DashboardPage() {
  ...
  const weeklyMax = useMemo(() => {
    return weeklyPoints.length
      ? Math.max(...weeklyPoints.map((item) => item.count))
      : 0;
  }, [weeklyPoints]);
  ...
  const conversionMeta = useMemo(() => {
    ...
    const passedOnsite =
      (byStatus.onsite ?? 0) + (byStatus.offer ?? 0) + (byStatus.accepted ?? 0);
          ...
          <>
            ...
            <section className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-xl">
                <h1
                  className="text-3xl font-bold tracking-[-0.02em] lg:text-4xl"
                  style={{
                    fontFamily: "var(--font-manrope)",
                    color: "var(--text-primary)",
                  }}
                ...
                <p
                  className="mt-3 max-w-[60ch] text-sm leading-7"
                  style={{ color: "var(--text-secondary)" }}
                >
                  A quick view of what is moving forward, where the bottlenecks
                  are, and how your search looks right now.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-3">
                <Link href="/applications" className="btn btn-md btn-primary">
                  View applications
                </Link>
              </div>
            </section>
            ...
            >
              ...
              <dl className="mt-7 grid grid-cols-2 gap-x-6 gap-y-7 md:grid-cols-3 xl:grid-cols-6">
              ...
              <div
                className="mt-7 grid grid-cols-3 gap-6 pt-6"
                ...
                {!hasWeeklyActivity ? (
                  ...
                  >
                    ...
                    <p
                      ...
                      style={{ color: "var(--text-secondary)" }}
                    >
                      Start adding applications and your weekly trend will show
                      up here.
                    </p>
                  </div>
                ) : !hasEnoughWeeklyData ? (
